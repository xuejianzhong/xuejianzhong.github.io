    ...
    'chart': function chartData() {
        ...
        optionC = {
            ...
            series: [{
                    name: '生产量',
                    type: 'bar',
                    data: [870, 760.9, 850.0, 758.2, 985.6, 576.7, 535.6, 762.2, 732.6, 420.0, 556.4, 663.3]
                },
                {
                    name: '销售量',
                    type: 'bar',
                    data: [662.6, 695.9, 819.0, 426.4, 728.7, 670.7, 575.6, 482.2, 748.7, 518.8, 556.0, 772.3]
                },
                // {
                //     name: '平均',
                //     type: 'line',
        ...
        optionB = {
            ...
            series: [{
                ...
                // },
                {
                    ...
                    data: [{
                            name: '成交量',
                            value: [80, 70, 70, 50, 46.7, 75.7, 75.6, 82.2, 48.7, 70, 50, 60],
                        },
                        {
                            // name: '蒸发量',
