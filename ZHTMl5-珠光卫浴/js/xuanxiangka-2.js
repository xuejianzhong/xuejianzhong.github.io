...
$(".btn-group a").click(function(){
    ...
    $("body section").eq(n+1).fadeIn(400).siblings().not(".nav-2").not("header").not("footer").fadeOut(400);
    return false;
})
...
$(".btn-group a").click(function(){
    ...
    $("body section").eq(sessionStorage.indea).show().siblings().not(".nav-2").not("header").not("footer").hide();
})
$("body section").eq(sessionStorage.indea).show().siblings().not(".nav-2").not("header").not("footer").hide();
